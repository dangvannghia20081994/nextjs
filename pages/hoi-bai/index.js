      ...
      <div className='container'>
        <div className='row gy-2'>
          <div className='col-lg-8'>
            ...
            <div className='text-center text-primary bg-white fw-bold py-2 shadow mt-3 rounded-1'><span className='pointer'>Có +24 câu hỏi mới</span></div>
            <div className='list-question'>
              {list.map((it, ind) => (
                <QuestionItem key={ind} item={it} className="mt-3 question-item bg-white shadow rounded-2 py-3 px-4" />
              ))}
            </div>
            <div className='text-center text-primary bg-white fw-bold py-2 shadow mt-3 rounded-1'><span className='pointer' onClick={loadData}>Xem thêm</span></div>
          </div>
          <div className='col-lg-4'>
            <UserInfo className="bg-white" />
            <Loging className="mt-3" />
          </div>
        </div>
      </div>
      <style jsx>
