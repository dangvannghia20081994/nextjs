    ...
    <div>
      <footer className={`py-3 px-0 px-lg-4 h5 mb-0`}>
        <div className="container">
          <div className="row gy-3">
            ...
            <div className="col-lg-6">
              <div className={`white-space-break pb-2 lh-lg`}>
                <b>Công ty chủ quản:</b> Công ty Cổ phần Đầu tư Phát triển Công
                nghệ Điện tử Viễn thông (Elcom Corp){"\n"}
                <b>Trụ sở chính:</b> Tòa nhà ELCOM, phố Duy Tân,quận ​Cầu
                Giấy,thành phố Hà Nội, Việt Nam{"\n"}
                <b>Giấy chứng nhận ĐKKD:</b> số 0101435127 do Sở Kế hoạch & Đầu
                tư Thành phố Hà Nội.{"\n"}
                Cấp ngày 18/07/2003.{"\n"}
            ...
            <div className="col-8 col-lg-2">
              ...
              <div className="list pt-3">
                <div className="item pb-2">
                  <Mobile className="me-2" />
                  Hotline: 1900866648
                </div>
                <div className="item pb-2">
                  <Email className="me-2" />
                  support@colearn.com.vn
                </div>
              </div>
              <div className="title text-uppercase fw-bold">
                Tải ứng dụng colearn
              </div>
              <div className="list pt-3">
                ...
                <div className="item pt-2 fst-italic small">
          ...
          <div className="small">
            © 2020 - Bản quyền thuộc về Công ty cổ phần Elcom
          </div>
        </div>
      </footer>
      <ModalLogin/>
